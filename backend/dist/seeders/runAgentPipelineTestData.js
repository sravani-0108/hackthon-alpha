 ...
 */
async function seedAgentPipelineTestData() {
    ...
    try {
        ...
        const scenarios = [
            ...
            },
            {
                ...
                trigger: { amount: 2500000, type: 'Transfer', from: 'ACCT-A003', to: 'EXT-IR', country: 'Iran', daysAgo: 1 },
                alert: {
                    code: 'ALT-A003',
                    type: 'High-Risk Country',
                    reason: 'Step 3 — Sanctions Agent: transfer to Iran + OpenSanctions name screening',
                    risk_score: 94,
                    severity: 'Critical',
                    expected: 'Sanctions → SAR',
                },
            },
            {
        ...
        for (const s of scenarios) {
         ...
         VALUES ($1,$2,$3,$4, NOW() - INTERVAL '3 years') RETURNING id`, [custId, s.account.num, s.account.type, s.account.balance]);
           ...
           VALUES ($1,$2,$3,$4,$5,'India',$6,'Completed')`, [accId, h.amount, h.type, h.from, h.to ?? s.account.num, day(h.daysAgo)]);
            }
...
exports.default = seedAgentPipelineTestData;
//# sourceMappingURL=runAgentPipelineTestData.js.map