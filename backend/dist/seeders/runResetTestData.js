    ...
    try {
        ...
        const scenarios = [
            ...
            },
            {
                ...
                trigger: { amount: 950000, type: 'Transfer', from: 'ACCT-T003', to: 'EXT-EU', daysAgo: 2 },
                alert: {
                    code: 'ALT-T003',
                    type: 'PEP Transaction',
                    reason: 'High-value transfer by PEP — live OpenSanctions screening',
                    risk_score: 78,
                    severity: 'Critical',
                    expected: 'ESCALATE / SAR',
                },
            },
            {
                customer: {
                ...
                trigger: { amount: 1200000, type: 'Transfer', from: 'ACCT-T004', to: 'EXT-IR', country: 'Iran', daysAgo: 1 },
                alert: {
                    code: 'ALT-T004',
                    type: 'High-Risk Country',
                    reason: '₹12L transfer to Iran — sanctions geography + name screening',
                    risk_score: 92,
                    severity: 'Critical',
                    expected: 'SAR',
                },
