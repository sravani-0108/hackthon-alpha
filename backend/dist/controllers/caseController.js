...
exports.getCases = (0, asyncHandler_1.default)(async (req, res) => {
    const result = await caseService_1.default.getCases(req.query);
    return apiResponse.paginated(res, result.cases, result.pagination);
});
exports.getCaseById = (0, asyncHandler_1.default)(async (req, res) => {
    const amlCase = await caseService_1.default.getCaseById(parseInt(req.params.id, 10));
    return apiResponse.success(res, amlCase, 'Case retrieved.');
});
exports.assignCase = (0, asyncHandler_1.default)(async (req, res) => {
    const amlCase = await caseService_1.default.assignCase(parseInt(req.params.id, 10), req.body.userId || req.user.id);
