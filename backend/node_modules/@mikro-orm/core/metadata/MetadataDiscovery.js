...
class MetadataDiscovery {
    ...
    sameRelationTargetRoot(rootProp, prop) {
        ...
        if (prop.kind !== enums_1.ReferenceKind.MANY_TO_ONE && prop.kind !== enums_1.ReferenceKind.ONE_TO_ONE) {
            return false;
        }
    ...
    initSingleTableInheritance(meta, metadata) {
        ...
        Object.values(meta.properties).forEach(prop => {
            ...
            if (rootProp && !narrowedRelationOverride && (rootProp.type !== prop.type || (rootProp.fieldNames && prop.fieldNames && !(0, Utils_1.compareArrays)(rootProp.fieldNames, prop.fieldNames)))) {
