...
class EntityFactory {
    ...
    create(entityName, data, options = {}) {
        ...
        if (EntityHelper_1.EntityHelper.isEntity(data)) {
            return data;
        }
    ...
    mergeData(meta, entity, data, options = {}) {
        ...
        const initialized = options.initialized || (0, wrap_1.helper)(entity).__initialized;
        ...
        Utils_1.Utils.keys(diff2).forEach(key => {
            ...
            if (!options.convertCustomTypes && [enums_1.ReferenceKind.MANY_TO_ONE, enums_1.ReferenceKind.ONE_TO_ONE, enums_1.ReferenceKind.SCALAR].includes(prop.kind) && prop.customType?.ensureComparable(meta, prop) && diff2[key] != null) {
