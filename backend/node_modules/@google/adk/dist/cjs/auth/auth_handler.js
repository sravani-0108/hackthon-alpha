...
var import_oauth2_credential_exchanger = require("./oauth2/oauth2_credential_exchanger.js");
/**
 * @license
...
class AuthHandler {
  ...
  async parseAndStoreAuthResponse(state) {
    ...
    if (this.authConfig.exchangedAuthCredential) {
      const exchanger = new import_oauth2_credential_exchanger.OAuth2CredentialExchanger();
  ...
  generateAuthUri() {
    ...
    const state = (0, import_env_aware_utils.randomUUID)();
