...
class AgentTool extends (_b = import_base_tool.BaseTool, _a = AGENT_TOOL_SIGNATURE_SYMBOL, _b) {
  ...
  async runAsync({
    ...
    if ((_c = toolContext.abortSignal) == null ? void 0 : _c.aborted) {
      return "";
    }
    let lastEvent;
    for await (const event of runner.runAsync({
      ...
      if ((_d = toolContext.abortSignal) == null ? void 0 : _d.aborted) {
        return;
      }
    ...
    if (!((_f = (_e = lastEvent == null ? void 0 : lastEvent.content) == null ? void 0 : _e.parts) == null ? void 0 : _f.length)) {
      return "";
    }
    const hasOutputSchema = (0, import_llm_agent.isLlmAgent)(this.agent) && this.agent.outputSchema;
