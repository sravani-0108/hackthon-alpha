...
class PluginManager {
  ...
  async runBeforeToolSelection({
    ...
    return await this.runCallbacks(
      this.plugins,
      (plugin) => plugin.beforeToolSelection({ callbackContext, tools }),
      "beforeToolSelection"
    );
  }
  /**
  ...
  async runBeforeContextCompaction({
    ...
    await this.runCallbacks(
      this.plugins,
      (plugin) => plugin.beforeContextCompaction({ invocationContext, trigger }),
  ...
  async runAfterContextCompaction({
    ...
    await this.runCallbacks(
      this.plugins,
      (plugin) => plugin.afterContextCompaction({ invocationContext, trigger }),
