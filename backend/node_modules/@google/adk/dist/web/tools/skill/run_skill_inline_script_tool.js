...
let RunSkillInlineScriptTool = class extends BaseTool {
  ...
  async runAsync({
    ...
    try {
      ...
      return {
        error: "Failed to execute inline script: ".concat(e.message),
